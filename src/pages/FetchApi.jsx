                ...
                data.map(movie => (
                    <div>
                        <div class="grid md:grid-cols-2 items-center gap-12 max-w-5xl max-md:max-w-md mx-auto p-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-semibold text-slate-900 !leading-tight">{movie.name}</h2>
                                <p class="mt-4 text-[15px] text-slate-600 font-medium leading-relaxed">{movie.overview}</p>
                                <div class="mt-8 text-left">
                                    <h4 class="text-base font-semibold">Mark Adair</h4>
                                    <p class="text-xs text-slate-600 mt-1">markadair23@gmail.com</p>
                                </div>
