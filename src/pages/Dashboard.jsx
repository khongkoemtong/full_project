    ...
    <div>
      ...
      <header class="flex shadow-md py-1 px-4 sm:px-7 bg-white min-h-[70px] tracking-wide z-[110] fixed top-0 w-full">
        <div class="flex flex-wrap items-center justify-between gap-4 w-full relative">
          ...
          <div id="collapseMenu"
            ...
            <div
              ...
              <div class="flex items-center max-lg:flex-col-reverse max-lg:ml-auto gap-8">
                <div
                  class="flex w-full bg-gray-100 px-4 py-2.5 rounded-sm outline-0 border border-gray-200 focus-within:border-blue-600 focus-within:bg-transparent transition-all">
                  <input type='text' placeholder='Search something...'
                    class="w-full text-sm bg-transparent rounded-sm outline-0 pr-2" />
                  ...
                  <div
                    ...
                    <div class="w-full">
                      <a href="javascript:void(0)"
                        class="text-[15px] text-slate-800 cursor-pointer flex items-center p-2 rounded-md hover:bg-gray-100 dropdown-item transition duration-300 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-[18px] h-[18px] font-medium mr-3 fill-current"
                          viewBox="0 0 512 512">
                          <path
                      ...
                      <a href="javascript:void(0)"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                          class="w-[18px] h-[18px] font-medium mr-3 fill-current" viewBox="0 0 24 24">
                          <path
          ...
          <button id="toggleOpen" class="lg:hidden !ml-7 outline-0">
      ...
      <h1 className='en'>hello</h1>
      <h1 className='en'>hello</h1>

      <div>
        <div class="flex items-start">
          <nav id="sidebar" class="lg:min-w-[280px] w-max max-lg:min-w-8">
            <div id="sidebar-collapse-menu"
              class="bg-white shadow-lg h-screen fixed py-6 px-4 top-[70px] left-0 overflow-auto z-[99] lg:min-w-[270px] lg:w-max max-lg:w-0 max-lg:invisible transition-all duration-500">
              <ul class="space-y-1.5">
                <li>
                  <a href="javascript:void(0)"
                    class="text-slate-800 text-[15px] font-medium flex items-center hover:bg-gray-100 rounded-md px-4 py-2 transition-all">
                ...
                <ul class="mt-3 space-y-1.5">
                  <li>
                    <a href="javascript:void(0)"
                      ...
                      <span className='en'>Audience</span>
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)"
              ...
              <div class="mt-6">
                <h6 class="text-blue-600 text-sm font-semibold px-4">General Settings</h6>
                <ul class="mt-3 space-y-1.5">
                  <li>
                    <a href="javascript:void(0)"
                      class="text-slate-800 text-[15px] font-medium flex items-center hover:bg-gray-100 rounded-md px-4 py-2 transition-all">
          ...
          <button id="toggle-sidebar"
            class="lg:hidden w-8 h-8 z-[100] fixed top-[74px] left-[10px] cursor-pointer bg-[#007bff] flex items-center justify-center rounded-full outline-0 transition-all duration-500">
